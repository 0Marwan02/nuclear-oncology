...
// PET-CT
router.post('/petct', doctorOnly, upload.single('scanFile'), createPETCT);
...
// PSMA PET-CT
router.post('/psma', doctorOnly, upload.single('scanFile'), createPSMAPETCT);
...
// Thyroid
router.post('/thyroid', doctorOnly, upload.single('scanFile'), createThyroid);
...
// Bone
router.post('/bone', doctorOnly, upload.single('scanFile'), createBone);
...
// Renal
router.post('/renal', doctorOnly, upload.single('scanFile'), createRenal);
...
// Gastric
router.post('/gastric', doctorOnly, upload.single('scanFile'), createGastric);
...
// Meckel
router.post('/meckel', doctorOnly, upload.single('scanFile'), createMeckel);
